...
json_file_path = "C:\\Users\\Saqib\\PycharmProjects\\GAGE\output_AED\\bundlore\\origin_292__.tmp0.json"
extracted_ex_file_path = "robustness_files/bundlore/gage_cfg/ex_bundlore_origin_292__.tmp0.json"


#graph_gen = 'models/padded_graph_generator_20231009_CFGExplainer_v2_gamarue_Included.pkl'
#model_name = "models/GCN_20231009_CFGExplainer_v2_gamarue_included.h5"

graph_gen = 'models/padded_graph_generator_20231009_GCN_gage_cfg_v2_gamarue_included.pkl'
model_name = "models/GCN_20231009_GCN_gage_cfg_v2_gamarue_included.h5"
            ...
            if not nodes:
                ...
                for node in graph_data["Nodes"]:
                    ...
                    if cpid in nodes:
                        ...
                        node_features[cpid] = [
                            features + [node_degrees.get(cpid, 0), incoming_edges.get(cpid, 0)] + node["AED_features"][
                                0]]
...
def genetic_algorithm(population_size, cromo_length, parent_edges, edges_map, parent_graph, parent_health, mutation_rate, n_top, generations=10):
    ...
    for i in range(generations):
        ...
        this_generations_fitness = fitness(final_subgraph, parent_health)
        print(this_generations_fitness)
        gererations_fitness.append(this_generations_fitness)
...
if __name__ == '__main__':
    ...
    #print(generations_fitness)
    # print(fittest_in_generations, "\n", generations_fitness)
    #fittest_in_generations = [111, 12, 111, 99, 1, 182, 34, 76, 57, 38, 145, 130, 196, 70, 52, 18, 46, 172, 179, 96, 99, 117, 145, 2, 125]
