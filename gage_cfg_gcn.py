                ...
                with open(os.path.join(class_folder_path, json_file), 'r') as file:
                    ...
                    for node in graph_data["Nodes"]:
                        ...
                        if cpid in nodes:
                            ...
                            node_features[cpid] = [features + [node_degrees.get(cpid, 0), incoming_edges.get(cpid, 0)] + node["AED_features"][0]]
...
with open('models/padded_graph_generator_20231009_GCN_gage_cfg_v3_gamarue_included.pkl', 'wb') as file:
...
model_name = "models/GCN_20231009_GCN_gage_cfg_v3_gamarue_included.h5"
