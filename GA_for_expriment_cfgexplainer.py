...
json_file_path = "C:\\Users\\Saqib\\PycharmProjects\\GAGE\output_AED\\emotet\\origin_424__.tmp0.json"
extracted_ex_file_path = "robustness_files/emotet/cfgexplainer/ex_emotet_origin_424__.tmp0.json"
            ...
            if not nodes:
                ...
                for node in graph_data["Nodes"]:
                    ...
                    if cpid in nodes:
                        ...
                        node_features[cpid] = [
                            features + [node_degrees.get(cpid, 0), incoming_edges.get(cpid, 0)]]
...
if __name__ == '__main__':
    ...
    #fittest_in_generations = [62, 14, 43, 191, 53, 8, 69, 49, 150, 93, 191, 133, 68, 40, 2, 128, 82, 28, 209, 68, 197, 96, 16, 25, 45]
